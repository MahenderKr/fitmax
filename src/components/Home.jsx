    ...
    <>
      ...
      <header className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Expert guidance tailored to your body, your lab results, and your lifestyle.
          </p>
        </div>
      </header>

      {/* Featured Blood Report Section */}
      <section className="featured-report-section">
        <div className="featured-report-card">
          ...
          <div className="featured-report-content">
            ...
            <h2>Self-Blood Report Analysis</h2>

            <p>
              Understand what your blood reports mean and get personalized
              nutrition recommendations based on your results.
            </p>

            <ul>
              <li>✓ Detailed interpretation of your blood reports</li>
              <li>✓ Identify important nutritional markers</li>
              <li>✓ Personalized dietary recommendations</li>
              <li>✓ Practical guidance for better health</li>
            </ul>

            <button
              className="report-analysis-btn"
      ...
      <section className="services-section" id="services">
        <div className="section-header">
          <h2>My Services</h2>
          <p>
            Comprehensive consulting to help you achieve your wellness goals.
          </p>
        </div>
